...
export default function Banner(props) {
  ...
  return (
    <div className={`relative z-10 w-full isolate flex items-center gap-x-6 bg-gray-50 overflow-hidden bg-transparent px-6 py-2.5 sm:px-3.5 sm:before:flex-1  ${showBanner === true ? "flex" : "hidden"}`}>
      <div
